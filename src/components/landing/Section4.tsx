...
const InfoCard: React.FC<InfoCardProps> = ({ svg, title, description }) => {
  return (
    <div className='w-full max-w-xs h-90 bg-gradient-to-br from-[#B70849] to-[#652CFE] p-0.5 rounded-4xl'>
      <div className='w-full h-full bg-black rounded-4xl flex flex-col items-center p-4'>
        ...
        <h4 className='text-xl sm:text-2xl font-medium mb-6 text-center'>
          {title.split('\n').map((line, index) => (
