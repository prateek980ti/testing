...
export function Button({
	...
	const classes = {
		basic:
			"relative z-10 text-primaryB text-center flex justify-center items-center disabled:before:hidden disabled:bg-disabled relative before:content-[''] before:block border before:-z-10 before:absolute before:inset-0 rounded-lg before:rounded-lg font-medium hover:bg-primaryA/10",
		variant: {
			primary:
